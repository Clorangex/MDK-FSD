...
public:
	...
	CMember(EDLSSSettingOverride)                      EnableScreenpercentageManipulationInDLSSEditorViewportsOverride OFFSET(get<T>, {0x29, 1, 0, 0})
	CMember(EDLSSSettingOverride)                      EnableDLSSInPlayInEditorViewportsOverride                   OFFSET(get<T>, {0x2A, 1, 0, 0})
	DMember(bool)                                      bShowDLSSIncompatiblePluginsToolsWarnings                   OFFSET(get<bool>, {0x2B, 1, 0, 0})
	CMember(EDLSSSettingOverride)                      ShowDLSSSDebugOnScreenMessages                              OFFSET(get<T>, {0x2C, 1, 0, 0})
};
...
public:
	...
	DMember(bool)                                      bEnableScreenpercentageManipulationInDLSSEditorViewports    OFFSET(get<bool>, {0x2C, 1, 0, 0})
	DMember(bool)                                      bEnableDLSSInPlayInEditorViewports                          OFFSET(get<bool>, {0x2D, 1, 0, 0})
	DMember(bool)                                      bShowDLSSSDebugOnScreenMessages                             OFFSET(get<bool>, {0x2E, 1, 0, 0})
	...
	CMember(EDLSSPreset)                               DLAAPreset                                                  OFFSET(get<T>, {0x5A, 1, 0, 0})
	CMember(EDLSSPreset)                               DLSSQualityPreset                                           OFFSET(get<T>, {0x5C, 1, 0, 0})
	CMember(EDLSSPreset)                               DLSSBalancedPreset                                          OFFSET(get<T>, {0x5D, 1, 0, 0})
	CMember(EDLSSPreset)                               DLSSPerformancePreset                                       OFFSET(get<T>, {0x5E, 1, 0, 0})
	CMember(EDLSSPreset)                               DLSSUltraPerformancePreset                                  OFFSET(get<T>, {0x5F, 1, 0, 0})
};
