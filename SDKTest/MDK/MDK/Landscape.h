...
public:
	DMember(float)                                     VirtualTextureMainPassMaxDrawDistance                       OFFSET(get<float>, {0x4E0, 4, 0, 0})
};
...
public:
	...
	// void SetLandscapeMaterialVectorParameterValue(FName ParameterName, FLinearColor Value);                                  // [0x2ddc350] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.SetLandscapeMaterialTextureParameterValue
	// void SetLandscapeMaterialTextureParameterValue(FName ParameterName, class UTexture* Value);                              // [0x2ddc280] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.SetLandscapeMaterialScalarParameterValue
	// void SetLandscapeMaterialScalarParameterValue(FName ParameterName, float Value);                                         // [0x2ddc1b0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.LandscapeExportHeightmapToRenderTarget
	// bool LandscapeExportHeightmapToRenderTarget(class UTextureRenderTarget2D* InRenderTarget, bool InExportHeightIntoRGChannel, bool InExportLandscapeProxies); // [0x2ddc090] Final|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.EditorSetLandscapeMaterial
	// void EditorSetLandscapeMaterial(class UMaterialInterface* NewLandscapeMaterial);                                         // [0x1828b70] Final|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.EditorApplySpline
	// void EditorApplySpline(class USplineComponent* InSplineComponent, float StartWidth, float EndWidth, float StartSideFalloff, float EndSideFalloff, float StartRoll, float EndRoll, int32_t NumSubdivisions, bool bRaiseHeights, bool bLowerHeights, class ULandscapeLayerInfoObject* PaintLayer, FName EditLayerName); // [0x2ddbd00] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeUseTessellationComponentScreenSizeFalloff
	// void ChangeUseTessellationComponentScreenSizeFalloff(bool InComponentScreenSizeToUseSubSections);                        // [0x1994fc0] Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeTessellationComponentScreenSizeFalloff
	// void ChangeTessellationComponentScreenSizeFalloff(float InUseTessellationComponentScreenSizeFalloff);                    // [0x2ddbc70] Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeTessellationComponentScreenSize
	// void ChangeTessellationComponentScreenSize(float InTessellationComponentScreenSize);                                     // [0x2ddbbe0] Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeLODDistanceFactor
	// void ChangeLODDistanceFactor(float InLODDistanceFactor);                                                                 // [0x2ddbb50] Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeComponentScreenSizeToUseSubSections
	// void ChangeComponentScreenSizeToUseSubSections(float InComponentScreenSizeToUseSubSections);                             // [0x2ddbac0] Native|Public|BlueprintCallable 
};
...
public:
	...
	// void RequestLandscapeUpdate();                                                                                           // [0xbd29a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeBlueprintBrushBase.Render
	// class UTextureRenderTarget2D* Render(bool InIsHeightmap, class UTextureRenderTarget2D* InCombinedResult, FName& InWeightmapLayerName); // [0x2dda3f0] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/Landscape.LandscapeBlueprintBrushBase.Initialize
	// void Initialize(FTransform& InLandscapeTransform, FIntPoint& InLandscapeSize, FIntPoint& InLandscapeRenderTargetSize);   // [0x2dda270] Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/Landscape.LandscapeBlueprintBrushBase.GetBlueprintRenderDependencies
	// void GetBlueprintRenderDependencies(TArray<UObject*>& OutStreamableAssets);                                              // [0x1d6f900] Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	DMember(int32_t)                                   SectionBaseX                                                OFFSET(get<int32_t>, {0x450, 4, 0, 0})
	DMember(int32_t)                                   SectionBaseY                                                OFFSET(get<int32_t>, {0x454, 4, 0, 0})
	DMember(int32_t)                                   ComponentSizeQuads                                          OFFSET(get<int32_t>, {0x458, 4, 0, 0})
	DMember(int32_t)                                   SubsectionSizeQuads                                         OFFSET(get<int32_t>, {0x45C, 4, 0, 0})
	DMember(int32_t)                                   NumSubsections                                              OFFSET(get<int32_t>, {0x460, 4, 0, 0})
	CMember(class UMaterialInterface*)                 OverrideMaterial                                            OFFSET(get<T>, {0x468, 8, 0, 0})
	CMember(class UMaterialInterface*)                 OverrideHoleMaterial                                        OFFSET(get<T>, {0x470, 8, 0, 0})
	CMember(TArray<FLandscapeComponentMaterialOverride>) OverrideMaterials                                         OFFSET(get<T>, {0x478, 16, 0, 0})
	CMember(TArray<class UMaterialInstanceConstant*>)  MaterialInstances                                           OFFSET(get<T>, {0x488, 16, 0, 0})
	CMember(TArray<class UMaterialInstanceDynamic*>)   MaterialInstancesDynamic                                    OFFSET(get<T>, {0x498, 16, 0, 0})
	CMember(TArray<int8_t>)                            LODIndexToMaterialIndex                                     OFFSET(get<T>, {0x4A8, 16, 0, 0})
	CMember(TArray<int8_t>)                            MaterialIndexToDisabledTessellationMaterial                 OFFSET(get<T>, {0x4B8, 16, 0, 0})
	CMember(class UTexture2D*)                         XYOffsetmapTexture                                          OFFSET(get<T>, {0x4C8, 8, 0, 0})
	SMember(FVector4)                                  WeightmapScaleBias                                          OFFSET(getStruct<T>, {0x4D0, 16, 0, 0})
	DMember(float)                                     WeightmapSubsectionOffset                                   OFFSET(get<float>, {0x4E0, 4, 0, 0})
	SMember(FVector4)                                  HeightmapScaleBias                                          OFFSET(getStruct<T>, {0x4F0, 16, 0, 0})
	SMember(FBox)                                      CachedLocalBox                                              OFFSET(getStruct<T>, {0x500, 28, 0, 0})
	CMember(TLazyObjectPtr<class ULandscapeHeightfieldCollisionComponent*>) CollisionComponent                     OFFSET(get<T>, {0x51C, 28, 0, 0})
	CMember(class UTexture2D*)                         HeightmapTexture                                            OFFSET(get<T>, {0x538, 8, 0, 0})
	CMember(TArray<FWeightmapLayerAllocationInfo>)     WeightmapLayerAllocations                                   OFFSET(get<T>, {0x540, 16, 0, 0})
	CMember(TArray<class UTexture2D*>)                 WeightmapTextures                                           OFFSET(get<T>, {0x550, 16, 0, 0})
	CMember(class ULandscapeLODStreamingProxy*)        LODStreamingProxy                                           OFFSET(get<T>, {0x560, 8, 0, 0})
	SMember(FGuid)                                     MapBuildDataId                                              OFFSET(getStruct<T>, {0x568, 16, 0, 0})
	CMember(TArray<FGuid>)                             IrrelevantLights                                            OFFSET(get<T>, {0x578, 16, 0, 0})
	...
	CMember(class UTexture2D*)                         GIBakedBaseColorTexture                                     OFFSET(get<T>, {0x5C8, 8, 0, 0})
	DMember(char)                                      MobileBlendableLayerMask                                    OFFSET(get<char>, {0x5D0, 1, 0, 0})
	CMember(class UMaterialInterface*)                 MobileMaterialInterface                                     OFFSET(get<T>, {0x5D8, 8, 0, 0})
	CMember(TArray<class UMaterialInterface*>)         MobileMaterialInterfaces                                    OFFSET(get<T>, {0x5E0, 16, 0, 0})
	CMember(TArray<class UTexture2D*>)                 MobileWeightmapTextures                                     OFFSET(get<T>, {0x5F0, 16, 0, 0})


	/// Functions
	// Function /Script/Landscape.LandscapeComponent.GetMaterialInstanceDynamic
	// class UMaterialInstanceDynamic* GetMaterialInstanceDynamic(int32_t InIndex);                                             // [0x2dda1a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Landscape.LandscapeComponent.EditorGetPaintLayerWeightByNameAtLocation
	// float EditorGetPaintLayerWeightByNameAtLocation(FVector& InLocation, FName InPaintLayerName);                            // [0x2dda0c0] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/Landscape.LandscapeComponent.EditorGetPaintLayerWeightAtLocation
	// float EditorGetPaintLayerWeightAtLocation(FVector& InLocation, class ULandscapeLayerInfoObject* PaintLayer);             // [0x2dd9fe0] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	CMember(TArray<class ULandscapeLayerInfoObject*>)  ComponentLayerInfos                                         OFFSET(get<T>, {0x450, 16, 0, 0})
	DMember(int32_t)                                   SectionBaseX                                                OFFSET(get<int32_t>, {0x460, 4, 0, 0})
	DMember(int32_t)                                   SectionBaseY                                                OFFSET(get<int32_t>, {0x464, 4, 0, 0})
	DMember(int32_t)                                   CollisionSizeQuads                                          OFFSET(get<int32_t>, {0x468, 4, 0, 0})
	DMember(float)                                     CollisionScale                                              OFFSET(get<float>, {0x46C, 4, 0, 0})
	DMember(int32_t)                                   SimpleCollisionSizeQuads                                    OFFSET(get<int32_t>, {0x470, 4, 0, 0})
	CMember(TArray<char>)                              CollisionQuadFlags                                          OFFSET(get<T>, {0x478, 16, 0, 0})
	SMember(FGuid)                                     HeightfieldGuid                                             OFFSET(getStruct<T>, {0x488, 16, 0, 0})
	SMember(FBox)                                      CachedLocalBox                                              OFFSET(getStruct<T>, {0x498, 28, 0, 0})
	CMember(TLazyObjectPtr<class ULandscapeComponent*>) RenderComponent                                            OFFSET(get<T>, {0x4B4, 28, 0, 0})
	CMember(TArray<class UPhysicalMaterial*>)          CookedPhysicalMaterials                                     OFFSET(get<T>, {0x4E0, 16, 0, 0})


	/// Functions
	// Function /Script/Landscape.LandscapeHeightfieldCollisionComponent.GetRenderComponent
	// class ULandscapeComponent* GetRenderComponent();                                                                         // [0x2dda240] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	CMember(TArray<FLandscapeMaterialTextureStreamingInfo>) TextureStreamingInfo                                   OFFSET(get<T>, {0x318, 16, 0, 0})
	DMember(bool)                                      bIsLayerThumbnail                                           OFFSET(get<bool>, {0x328, 1, 1, 0})
	DMember(bool)                                      bDisableTessellation                                        OFFSET(get<bool>, {0x328, 1, 1, 1})
	DMember(bool)                                      bMobile                                                     OFFSET(get<bool>, {0x328, 1, 1, 2})
	DMember(bool)                                      bEditorToolUsage                                            OFFSET(get<bool>, {0x328, 1, 1, 3})
};
...
public:
	SMember(FGuid)                                     MeshGuid                                                    OFFSET(getStruct<T>, {0x530, 16, 0, 0})
};
...
public:
	SMember(FGuid)                                     LandscapeGuid                                               OFFSET(getStruct<T>, {0x4E0, 16, 0, 0})
	CMember(TArray<FIntPoint>)                         ProxyComponentBases                                         OFFSET(get<T>, {0x4F0, 16, 0, 0})
	DMember(int8_t)                                    ProxyLOD                                                    OFFSET(get<int8_t>, {0x500, 1, 0, 0})
};
...
public:
	CMember(TArray<class ULandscapeSplineControlPoint*>) ControlPoints                                             OFFSET(get<T>, {0x450, 16, 0, 0})
	CMember(TArray<class ULandscapeSplineSegment*>)    Segments                                                    OFFSET(get<T>, {0x460, 16, 0, 0})
	CMember(TArray<class UMeshComponent*>)             CookedForeignMeshComponents                                 OFFSET(get<T>, {0x470, 16, 0, 0})


	/// Functions
	// Function /Script/Landscape.LandscapeSplinesComponent.GetSplineMeshComponents
	// TArray<USplineMeshComponent*> GetSplineMeshComponents();                                                                 // [0x189d560] Final|Native|Public|BlueprintCallable 
};
...
public:
	SMember(FExpressionInput)                          LayerUsed                                                   OFFSET(getStruct<T>, {0x40, 20, 0, 0})
	SMember(FExpressionInput)                          LayerNotUsed                                                OFFSET(getStruct<T>, {0x54, 20, 0, 0})
...
public:
	SMember(FExpressionInput)                          Base                                                        OFFSET(getStruct<T>, {0x40, 20, 0, 0})
	SMember(FExpressionInput)                          Layer                                                       OFFSET(getStruct<T>, {0x54, 20, 0, 0})
	SMember(FName)                                     ParameterName                                               OFFSET(getStruct<T>, {0x68, 8, 0, 0})
...
/// Class /Game/Landscape/PLS_Base.PLS_Base_C
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x4B8, 8, 0, 0})
	CMember(class USceneComponent*)                    DefaultSceneRoot                                            OFFSET(get<T>, {0x4C0, 8, 0, 0})
	CMember(class UMaterial*)                          OutlineMaterial                                             OFFSET(get<T>, {0x4C8, 8, 0, 0})
	CMember(TArray<class URoomGenerator*>)             Starting_Rooms                                              OFFSET(get<T>, {0x4D0, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  CompletedGenerationPass                                     OFFSET(getStruct<T>, {0x4E0, 16, 0, 0})
	CMember(class UMusicLibrary*)                      MusicOverride                                               OFFSET(get<T>, {0x4F0, 8, 0, 0})


	/// Functions
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.PlayDefaultAmbient
	// void PlayDefaultAmbient();                                                                                               // [0x1d6f900] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.EnsureSafelandingsite
	// void EnsureSafelandingsite();                                                                                            // [0x1d6f900] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.GetProceduralController
	// class UProceduralController* GetProceduralController();                                                                  // [0x1d6f900] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.SpawnCriticalItems
	// void SpawnCriticalItems(ECriticalItemPass pass);                                                                         // [0x1d6f900] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.HasSelectedCharacter
	// bool HasSelectedCharacter();                                                                                             // [0x1d6f900] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.CallGenerationComplete
	// void CallGenerationComplete(int32_t pass, TEnumAsByte<PLS_Passes> PLS Pass);                                             // [0x1d6f900] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.PlayMusicAndAmbient
	// void PlayMusicAndAmbient(int32_t musicIndex);                                                                            // [0x1d6f900] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.SaveInitialState
	// void SaveInitialState();                                                                                                 // [0x1d6f900] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.CreateCaveGraph
	// void CreateCaveGraph();                                                                                                  // [0x1d6f900] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.GetRandomRoom
	// void GetRandomRoom(TArray<URoomGenerator*>& Rooms, bool RemoveRoom, class URoomGenerator*& Room);                        // [0x1d6f900] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.OnLoaded_11827D59481E498DEC10999DAE2915BF
	// void OnLoaded_11827D59481E498DEC10999DAE2915BF(class UClass* Loaded);                                                    // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.OnLoaded_C0B2FCB247E1A2F8766E5E93EBF80DF8
	// void OnLoaded_C0B2FCB247E1A2F8766E5E93EBF80DF8(class UClass* Loaded);                                                    // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.ReceiveBeginPlay
	// void ReceiveBeginPlay();                                                                                                 // [0x1d6f900] Event|Protected|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.BaseLayerCommitDone
	// void BaseLayerCommitDone();                                                                                              // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.FinalCommitDone
	// void FinalCommitDone();                                                                                                  // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.CreateSpawn
	// void CreateSpawn();                                                                                                      // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.Generate_Graph
	// void Generate_Graph();                                                                                                   // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.Generate_Pass
	// void Generate_Pass();                                                                                                    // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.Generate_Pass
	// void Generate_Pass();                                                                                                    // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.Final Pass
	// void Final Pass();                                                                                                       // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.Generate_Pass_5_Server
	// void Generate_Pass_5_Server();                                                                                           // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.Generate_Pass_5_Clients
	// void Generate_Pass_5_Clients();                                                                                          // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.GenerateLandscape
	// void GenerateLandscape();                                                                                                // [0x1d6f900] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.Generate_Pass
	// void Generate_Pass();                                                                                                    // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.Generate_Pass
	// void Generate_Pass();                                                                                                    // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.BeginLiveGeneration
	// void BeginLiveGeneration();                                                                                              // [0x1d6f900] Event|Public|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.OnPLSDataRecieved
	// void OnPLSDataRecieved();                                                                                                // [0x1d6f900] Event|Public|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.AddRoomToInitialState
	// void AddRoomToInitialState(FRoomNode& RoomNode);                                                                         // [0x1d6f900] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.CreateGraphSecondPass
	// void CreateGraphSecondPass();                                                                                            // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.Generate_Tunnels
	// void Generate_Tunnels();                                                                                                 // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.StartGenerationOnClient
	// void StartGenerationOnClient(class AFSDPlayerController* client);                                                        // [0x1d6f900] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.GenerateLandscapeFromData
	...
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.CarveTunnels
	// void CarveTunnels();                                                                                                     // [0x1d6f900] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.Generate_Pass
	// void Generate_Pass();                                                                                                    // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.Generate_Pass_0_Client
	// void Generate_Pass_0_Client();                                                                                           // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.OnCarverDataRecieved
	// void OnCarverDataRecieved(EDebrisItemPass pass);                                                                         // [0x1d6f900] Event|Public|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.Generate_Pass
	// void Generate_Pass();                                                                                                    // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.Generate_Pass
	// void Generate_Pass();                                                                                                    // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.Generate_CriticalLargePass
	// void Generate_CriticalLargePass();                                                                                       // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.Generate_CriticalLargePass_Client
	// void Generate_CriticalLargePass_Client();                                                                                // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.StartMusicAndAmbient
	// void StartMusicAndAmbient(int32_t Music);                                                                                // [0x1d6f900] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.ExecuteUbergraph_PLS_Base
	// void ExecuteUbergraph_PLS_Base(int32_t EntryPoint);                                                                      // [0x1d6f900] Final|HasDefaults    
	// Function /Game/Landscape/PLS_Base.PLS_Base_C.CompletedGenerationPass__DelegateSignature
	// void CompletedGenerationPass__DelegateSignature(int32_t pass, TEnumAsByte<PLS_Passes> PLS Pass);                         // [0x1d6f900] Public|Delegate|BlueprintCallable|BlueprintEvent 
};

/// Class /Game/Landscape/PLS_CaveGenerator.PLS_CaveGenerator_C
...
public:
	...
	/// Functions
	// Function /Game/Landscape/PLS_CaveGenerator.PLS_CaveGenerator_C.CreateCaveGraph
	// void CreateCaveGraph();                                                                                                  // [0x1d6f900] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_CaveGenerator.PLS_CaveGenerator_C.CreateSpawn
	// void CreateSpawn();                                                                                                      // [0x1d6f900] BlueprintCallable|BlueprintEvent 
	// Function /Game/Landscape/PLS_CaveGenerator.PLS_CaveGenerator_C.ExecuteUbergraph_PLS_CaveGenerator
	// void ExecuteUbergraph_PLS_CaveGenerator(int32_t EntryPoint);                                                             // [0x1d6f900] Final|HasDefaults    
};

/// Class /Game/Landscape/Biomes/Biomes_Ingame/AzureWeald/Assets/MagicCrystals/AFE_FP_MagicCrystalDefense.AFE_FP_MagicCrystalDefense_C
...
/// Class /Game/Landscape/Biomes/Biomes_Ingame/AzureWeald/Assets/MagicCrystals/AFE_TP_MagicCrystalDefense.AFE_TP_MagicCrystalDefense_C
/// Size: 0x0000 (0x000048 - 0x000048)
class UAFE_TP_MagicCrystalDefense_C : public UAttachedParticlesAfflictionEffect
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 72;
...
/// Class /Game/Landscape/Biomes/Biomes_Ingame/AzureWeald/Assets/MagicHole/AFE_FP_MagicHoleMovement.AFE_FP_MagicHoleMovement_C
/// Size: 0x0000 (0x000048 - 0x000048)
...
/// Class /Game/Landscape/Biomes/Biomes_Ingame/AzureWeald/Assets/MagicHole/AFE_TP_MagicHoleMovement.AFE_TP_MagicHoleMovement_C
/// Size: 0x0000 (0x000048 - 0x000048)
...
/// Class /Game/Landscape/ReactiveTerrain/RT_DeepSnow.RT_DeepSnow_C
...
/// Class /Game/Landscape/ReactiveTerrain/STE_DeepSnowRT.STE_DeepSnowRT_C
...
/// Class /Game/Landscape/ReactiveTerrain/RT_Plague.RT_Plague_C
/// Size: 0x0000 (0x000030 - 0x000030)
class URT_Plague_C : public UStatusEffectReactiveTerrain
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 48;
...
/// Class /Game/Landscape/ReactiveTerrain/STE_PlagueRT.STE_PlagueRT_C
/// Size: 0x0000 (0x000108 - 0x000108)
...
/// Enum /Game/Landscape/PLS_Passes.PLS_Passes
/// Size: 0x15
enum class PLS_Passes : uint8_t
{
	PLS_Passes__NewEnumerator0                                                       = 0,
	PLS_Passes__NewEnumerator1                                                       = 1,
	PLS_Passes__NewEnumerator2                                                       = 2,
	PLS_Passes__NewEnumerator3                                                       = 3,
	PLS_Passes__NewEnumerator4                                                       = 4,
	PLS_Passes__NewEnumerator5                                                       = 5,
	PLS_Passes__NewEnumerator6                                                       = 6,
	PLS_Passes__NewEnumerator7                                                       = 7,
	PLS_Passes__NewEnumerator8                                                       = 8,
	PLS_Passes__NewEnumerator10                                                      = 9,
	PLS_Passes__NewEnumerator11                                                      = 10,
	PLS_Passes__NewEnumerator12                                                      = 11,
	PLS_Passes__NewEnumerator13                                                      = 12,
	PLS_Passes__NewEnumerator14                                                      = 13,
	PLS_Passes__NewEnumerator15                                                      = 14
};
