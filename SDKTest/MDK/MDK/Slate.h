...
public:
	SMember(FComboBoxStyle)                            ComboBoxStyle                                               OFFSET(getStruct<T>, {0x30, 1008, 0, 0})
};
...
public:
	SMember(FComboButtonStyle)                         ComboButtonStyle                                            OFFSET(getStruct<T>, {0x30, 952, 0, 0})
};
...
public:
	SMember(FEditableTextBoxStyle)                     EditableTextBoxStyle                                        OFFSET(getStruct<T>, {0x30, 2040, 0, 0})
};
...
public:
	SMember(FEditableTextStyle)                        EditableTextStyle                                           OFFSET(getStruct<T>, {0x30, 544, 0, 0})
};
...
public:
	SMember(FTextBlockStyle)                           TextBlockStyle                                              OFFSET(getStruct<T>, {0x30, 624, 0, 0})
};
