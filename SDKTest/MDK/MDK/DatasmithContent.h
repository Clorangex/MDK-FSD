...
public:
	CMember(TEnumAsByte<EComponentMobility>)           Mobility                                                    OFFSET(get<T>, {0x220, 1, 0, 0})
	CMember(EDatasmithAreaLightActorType)              LightType                                                   OFFSET(get<T>, {0x221, 1, 0, 0})
	CMember(EDatasmithAreaLightActorShape)             LightShape                                                  OFFSET(get<T>, {0x222, 1, 0, 0})
...
public:
	...
	// FString GetDatasmithUserDataValueForKey(class UObject* Object, FName Key);                                               // [0x1185c00] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataKeysAndValuesForValue
	// void GetDatasmithUserDataKeysAndValuesForValue(class UObject* Object, FString StringToMatch, TArray<FName>& OutKeys, TArray<FString>& OutValues); // [0x1185a40] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserData
	// class UDatasmithAssetUserData* GetDatasmithUserData(class UObject* Object);                                              // [0x11859b0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void PlayLevelSequence(class ULevelSequence* SequenceToPlay);                                                            // [0x1185d10] Final|Native|Public|BlueprintCallable 
};
