...
public:
	SMember(FRigElementKey)                            Root                                                        OFFSET(getStruct<T>, {0x68, 12, 0, 0})
	CMember(TArray<FFBIKEndEffector>)                  Effectors                                                   OFFSET(get<T>, {0x78, 16, 0, 0})
	CMember(TArray<FFBIKConstraintOption>)             Constraints                                                 OFFSET(get<T>, {0x88, 16, 0, 0})
	SMember(FSolverInput)                              SolverProperty                                              OFFSET(getStruct<T>, {0x98, 36, 0, 0})
	SMember(FMotionProcessInput)                       MotionProperty                                              OFFSET(getStruct<T>, {0xBC, 2, 0, 0})
	DMember(bool)                                      bPropagateToChildren                                        OFFSET(get<bool>, {0xBE, 1, 0, 0})
	SMember(FFBIKDebugOption)                          DebugOption                                                 OFFSET(getStruct<T>, {0xC0, 80, 0, 0})
	SMember(FRigUnit_FullbodyIK_WorkData)              WorkData                                                    OFFSET(getStruct<T>, {0x110, 408, 0, 0})
};
