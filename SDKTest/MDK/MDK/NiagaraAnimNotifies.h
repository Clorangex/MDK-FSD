...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect();                                                                            // [0xbd8bb0] Final|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect(class UMeshComponent* MeshComp);                                              // [0xbd8b10] Final|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// float GetNotifyProgress(class UMeshComponent* MeshComp);                                                                 // [0xbd8a70] Final|Native|Public|BlueprintCallable|Const 
};
