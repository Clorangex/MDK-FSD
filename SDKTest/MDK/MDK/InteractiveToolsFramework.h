...
public:
	...
	SMember(FBrushStampData)                           LastBrushStamp                                              OFFSET(getStruct<T>, {0xD0, 168, 0, 0})
	CMember(TSoftObjectPtr<class UClass*>)             PropertyClass                                               OFFSET(get<T>, {0x188, 40, 0, 0})
	CMember(class UBrushStampIndicator*)               BrushStampIndicator                                         OFFSET(get<T>, {0x1B0, 8, 0, 0})
};
...
public:
	SMember(FLinearColor)                              Color                                                       OFFSET(getStruct<T>, {0x450, 16, 0, 0})
	DMember(float)                                     HoverSizeMultiplier                                         OFFSET(get<float>, {0x460, 4, 0, 0})
	DMember(float)                                     PixelHitDistanceThreshold                                   OFFSET(get<float>, {0x464, 4, 0, 0})


	/// Functions
	// Function /Script/InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState
	// void UpdateWorldLocalState(bool bWorldIn);                                                                               // [0x3be8a40] Final|Native|Public  
	// Function /Script/InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState
	// void UpdateHoverState(bool bHoveringIn);                                                                                 // [0x3be89b0] Final|Native|Public  
};
...
public:
	SMember(FVector)                                   Direction                                                   OFFSET(getStruct<T>, {0x470, 12, 0, 0})
	DMember(float)                                     Gap                                                         OFFSET(get<float>, {0x47C, 4, 0, 0})
	DMember(float)                                     Length                                                      OFFSET(get<float>, {0x480, 4, 0, 0})
	DMember(float)                                     Thickness                                                   OFFSET(get<float>, {0x484, 4, 0, 0})
};
...
public:
	SMember(FVector)                                   Origin                                                      OFFSET(getStruct<T>, {0x470, 12, 0, 0})
	SMember(FQuat)                                     Rotation                                                    OFFSET(getStruct<T>, {0x480, 16, 0, 0})
	SMember(FVector)                                   Dimensions                                                  OFFSET(getStruct<T>, {0x490, 12, 0, 0})
	DMember(float)                                     LineThickness                                               OFFSET(get<float>, {0x49C, 4, 0, 0})
	DMember(bool)                                      bRemoveHiddenLines                                          OFFSET(get<bool>, {0x4A0, 1, 0, 0})
	DMember(bool)                                      bEnableAxisFlip                                             OFFSET(get<bool>, {0x4A1, 1, 0, 0})
};
...
public:
	SMember(FVector)                                   Normal                                                      OFFSET(getStruct<T>, {0x470, 12, 0, 0})
	DMember(float)                                     Radius                                                      OFFSET(get<float>, {0x47C, 4, 0, 0})
	DMember(float)                                     Thickness                                                   OFFSET(get<float>, {0x480, 4, 0, 0})
	DMember(int32_t)                                   NumSides                                                    OFFSET(get<int32_t>, {0x484, 4, 0, 0})
	DMember(bool)                                      bViewAligned                                                OFFSET(get<bool>, {0x488, 1, 0, 0})
	DMember(bool)                                      bOnlyAllowFrontFacingHits                                   OFFSET(get<bool>, {0x489, 1, 0, 0})
};
...
public:
	...
	// void SetTransform(FTransform& NewTransform);                                                                             // [0x3be8840] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoTransformSource.GetTransform
	// FTransform GetTransform();                                                                                               // [0x3be86b0] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// bool HasTangentVectors();                                                                                                // [0x18ce690] Native|Public|Const  
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors
	// void GetTangentVectors(FVector& TangentXOut, FVector& TangentYOut);                                                      // [0x3be85c0] Native|Public|HasOutParms|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetOrigin
	// FVector GetOrigin();                                                                                                     // [0x18faac0] Native|Public|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetDirection
	// FVector GetDirection();                                                                                                  // [0x3be8540] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// void UpdateHoverState(bool bHovering);                                                                                   // [0x3be8920] Native|Public|Const  
};
...
public:
	...
	// void EndUpdate();                                                                                                        // [0x19323b0] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoStateTarget.BeginUpdate
	// void BeginUpdate();                                                                                                      // [0x18cf220] Native|Public        
};
...
public:
	...
	// void SetParameter(FVector2D& NewValue);                                                                                  // [0x3be87b0] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter
	// FVector2D GetParameter();                                                                                                // [0x3be8580] Native|Public|HasDefaults|Const 
...
public:
	SMember(FVector)                                   Normal                                                      OFFSET(getStruct<T>, {0x470, 12, 0, 0})
	DMember(float)                                     HandleSize                                                  OFFSET(get<float>, {0x47C, 4, 0, 0})
	DMember(float)                                     Thickness                                                   OFFSET(get<float>, {0x480, 4, 0, 0})
	SMember(FVector)                                   Direction                                                   OFFSET(getStruct<T>, {0x484, 12, 0, 0})
	DMember(float)                                     Length                                                      OFFSET(get<float>, {0x490, 4, 0, 0})
	DMember(bool)                                      bImageScale                                                 OFFSET(get<bool>, {0x494, 1, 0, 0})
};
...
public:
	SMember(FVector)                                   DirectionX                                                  OFFSET(getStruct<T>, {0x470, 12, 0, 0})
	SMember(FVector)                                   DirectionY                                                  OFFSET(getStruct<T>, {0x47C, 12, 0, 0})
	DMember(float)                                     OffsetX                                                     OFFSET(get<float>, {0x488, 4, 0, 0})
	DMember(float)                                     OffsetY                                                     OFFSET(get<float>, {0x48C, 4, 0, 0})
	DMember(float)                                     LengthX                                                     OFFSET(get<float>, {0x490, 4, 0, 0})
	DMember(float)                                     LengthY                                                     OFFSET(get<float>, {0x494, 4, 0, 0})
	DMember(float)                                     Thickness                                                   OFFSET(get<float>, {0x498, 4, 0, 0})
	DMember(char)                                      SegmentFlags                                                OFFSET(get<char>, {0x49C, 1, 0, 0})
};
